...
| planned_after_token_rotation | ibm | ibm_fez | 30 | - | 4 | 1024 | - | - | - | - | pending_token_rotation_and_qpu_submission | `runs/quantum_architectures/verify_ibm_30_ibm_smoke_30.json` |
