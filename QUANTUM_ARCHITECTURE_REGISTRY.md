...
| Run | Dataset/System | Variant | Qubits | Layers | Node Features | Quantum Params | Total Params | Threshold | F1 | AUROC | AUPRC |
|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| `qgrid30_qgnn_calibrated` | qgrid IEEE 30-bus | calibrated | 4 | 2 | 4 | 24 | 189 | 0.3745 | 0.7550 | 0.8031 | 0.8604 |
| `qgrid30_qgnn_pilot` | qgrid IEEE 30-bus | pilot | 4 | 2 | 4 | 24 | 189 | - | 0.7262 | 0.8031 | 0.8604 |
| `ruan30_qgnn_calibrated` | ruan IEEE 30-bus | calibrated | 4 | 2 | 2 | 24 | 157 | 0.4776 | 0.6820 | 0.5214 | 0.6055 |
| `ruan30_qgnn_pilot` | ruan IEEE 30-bus | pilot | 4 | 2 | 2 | 24 | 157 | - | 0.6777 | 0.5338 | 0.6154 |
...
- Current QGNN runs are 4-qubit reduced detectors, not full 30/57/118-bus quantum models.
